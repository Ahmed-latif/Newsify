...
class Health extends StatefulWidget {
  ...
  @override
  State<Health> createState() => _SportsState();
}

class _SportsState extends State<Health> {
  final Dio dio = Dio();
  List<Article> articles = [];

  Future<List<Article>> getHealthNews() async {
    final response = await dio.get(
        'https://newsapi.org/v2/everything?q=health&apiKey=e0d44dca833446b1b371e9530e8eddc8');
