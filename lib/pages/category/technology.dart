...
class Technology extends StatefulWidget {
  ...
  @override
  State<Technology> createState() => _SportsState();
}

class _SportsState extends State<Technology> {
  final Dio dio = Dio();
  List<Article> articles = [];

  Future<List<Article>> getTechnologyNews() async {
    final response = await dio.get(
        'https://newsapi.org/v2/everything?q=technology&apiKey=e0d44dca833446b1b371e9530e8eddc8');
