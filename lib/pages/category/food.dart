...
class Food extends StatefulWidget {
  ...
  @override
  State<Food> createState() => _SportsState();
}

class _SportsState extends State<Food> {
  final Dio dio = Dio();
  List<Article> articles = [];

  Future<List<Article>> getFoodNews() async {
    final response = await dio.get(
        'https://newsapi.org/v2/top-headlines?q=food&apiKey=e0d44dca833446b1b371e9530e8eddc8');
