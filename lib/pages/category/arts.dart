...
class Arts extends StatefulWidget {
  ...
  @override
  State<Arts> createState() => _SportsState();
}

class _SportsState extends State<Arts> {
  final Dio dio = Dio();
  List<Article> articles = [];

  Future<List<Article>> getArtsNews() async {
    final response = await dio.get(
        'https://newsapi.org/v2/top-headlines?q=arts&apiKey=e0d44dca833446b1b371e9530e8eddc8');
